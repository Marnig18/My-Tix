		...
		return(
				<Grid fluid>
					<Row bsClass='row'>
						...
						<PageHeader className="whiteText">Create A New Event</PageHeader>
							<form method="POST" action="/api/event">
								<FormGroup controlId="newEventName"> 
									<ControlLabel className="whiteText">Event Name</ControlLabel>
								...
								<FormGroup controlId="newEventPicture"> 
									<ControlLabel className="whiteText">Picture</ControlLabel>
									<FormControl type="file" value={this.state.value} onChange={this.handleChange} />
								</FormGroup>
								<Button type="button" onClick={this.showModal} id="addPadding">Add an Option</Button>	
									<Modal
